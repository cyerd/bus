...
export default function SeatIcon({name}) {
  ...
  const color = isActive ? "gray" : "white";
  const next = isActive ? "gray" : "#ffff00";
  ...
  return (
    <div className="relative">
      <p
        className={classNames(
          ...
          "absolute left-3 font-bold text-xs top-2"
        )}
      >
        {name}
      </p>
      <svg
        ...
        onClick={handleClick}
      >
        <g fill={next} strokeWidth={1} stroke="gray" strokeMiterlimit={10}>
          <path
            className="st0"
	...
	c1.2-0.6,1.9-1.7,2.1-2.8c0.1-0.2,0.1-0.4,0.1-0.6l0-19.8C49.4,17.5,48.3,16.5,46.9,16.5L46.9,16.5z"
        ...
        <g fill={color} strokeWidth={1.2} stroke="gray" strokeMiterlimit={10}>
          <path
            className="st1"
