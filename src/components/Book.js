...
export default  function Booking ({ value, trip }) {
  ...
  const BookTicket = async (e) => {
    ...
    await mutate(uploadMessageToUpstash, {
      optimisticData: [messages, ...messages],
    ...
    <form onSubmit={BookTicket} className="flex w-full flex-col xl:flex-row">
      <div className="mx-1 w-full xl:w-9/12 ">
        ...
        <div className="bg-orange-200">
          ...
          <div>
            <div className="flex flex-col lg:flex-row mx-2 overflow-auto text-xs py-5">
          ...
          <div className="flex flex-col lg:flex-row mx-2 text-sm ">
            <div className="flex flex-col mx-1">
              ...
              <div className="flex bg-gray-100 items-center">
                ...
                <input value={sum} disabled onchange={(e)=>setSum(e.target.value)} type="text" className="bg-white text-red-500 px-5 rounded-lg text-center text-lg font-bold"/>
            ...
            <div className="flex flex-col mx-1 ">
              ...
              <select value={payment} onchange={(e)=>{setPayment(e.target.value)}} className="border-2 w-32 lg:w-full border-gray-300 px-1 text-lg text-center">
        ...
        <div className="flex justify-end flex-col  lg:flex-row mt-32 mb-10 text-lg mx-20 lg:mx-5">
          ...
          <button
            type="submit"
            className="bg-gray-800 text-white px-2 py-1 rounded mx-1 border border-gray-300 my-2 lg:my-0"
          >
            Book
          </button>
